window.crearBaseDatos = function () {
    ...
    window.query(sqlCliente).then(function () {
        console.log('Tabla sqlCliente creada.');
    }, function () {
        console.log('Error creando la tabla sqlCliente');
    })
    ...
    window.query(sqlVentas).then(function () {
        console.log('Tabla sqlVentas creada.');
    }, function () {
        console.log('Error creando la tabla sqlVentas');
    })
    window.query(sqlVentaDetalle).then(function () {
        console.log('Tabla sqlVentaDetalle creada.');
    }, function () {
        console.log('Error creando la tabla sqlVentaDetalle');
    })
}
